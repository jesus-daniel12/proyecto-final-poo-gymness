package ar.edu.huergo.jsanchezortega.gymness.controller.security;
...
import ar.edu.huergo.jsanchezortega.gymness.dto.security.LoginDTO;
...
@CrossOrigin(origins = "*", maxAge = 3600) // ← AGREGAR ESTA LÍNEA
